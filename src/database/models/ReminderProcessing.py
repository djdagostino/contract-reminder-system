...
class ExpirationReminderProcessing(Base):
    ...
    ExpReminderId = sa.Column(sa.Integer, primary_key=True, autoincrement=True)  
...
class StartReminderProcessing(Base):
    ...
    StartReminderId = sa.Column(sa.Integer, primary_key=True, autoincrement=True)  
    ContractID = sa.Column(sa.Integer, nullable=False)                       
...
class AutoRenewalReminderProcessing(Base):
    ...
    AutoReminderId = sa.Column(sa.Integer, primary_key=True, autoincrement=True)  
    ContractID = sa.Column(sa.Integer, nullable=False)                       
